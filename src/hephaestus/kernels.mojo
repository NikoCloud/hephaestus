...
def rope_kernel[
    ...
    # cast is f32-accum — more accurate than HF and was the spike root cause
    # (probe 14). Round after each mul and after the add/sub to match torch.
    # rotate_half form: out_re = re*cos + (-im)*sin ; out_im = im*cos + re*sin
